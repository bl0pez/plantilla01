...
const Hero = () => {
  return (
    ...
    >
      <div className="container mx-auto">
        <div className="flex items-center xl:h-[960px]">
          ...
          <div className="w-full xl:max-w-[460px] text-center xl:text-left">
            ...
            >
              Por: <span className="text-orange">Jhon Doe</span>
            </motion.p>
            <motion.p
            ...
            >
              ...
              asperiores, reiciendis labore sequi praesentium aperiam facere
              atque ratione recusandae ipsum laudantium enim deserunt id. Iste
              porro eum beatae nihil esse?
            </motion.p>
            <motion.div
              ...
              viewport={{ once: false, amount: 0.4 }}
            >
              <Button>Explorar el Menú</Button>
            </motion.div>
          </div>
          {/* Image */}
          <motion.div
      ...
      >
        <Image src="/hero/coffee.png" width={386} height={404} alt="coffe" />
      </motion.div>
    </section>
  );
};
